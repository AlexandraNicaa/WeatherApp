async function displayWeatherForecast (city) {
    ...
    list.forEach(element => {
        ...
        if (forecastMap[day]) {
            ...
            // altfel ii adaugam ziua saptamanii in obiect, alaturi de prima prognoza
        } else {
    ...
    for (const key in forecastMap) {
        ...
        prognoze.forEach(prognoza => {
            ...
            <strong class="fs-3">${temperature}°C</strong>
            <p class="weather-forecast">${weatherDescription}</p>
